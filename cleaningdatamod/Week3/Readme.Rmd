...
'MeanStd.df' data frame contains all the mean() and std() [standard deviation] columns from MergedData.  This was executed using the 
```{r eval=FALSE} 
grepl() 
```
...
With this criterion there should be 66 columns in total.
